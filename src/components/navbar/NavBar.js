    ...
    <nav className='nav-one'>
      <div className='nav-list-wrapper'>
        <ul className='nav-list-ul'>
            ...
            <li className='nav-link' onClick={()=>{handleBlank(); hideNav()}}><BiTime /> Timesheets</li>
            <li className='nav-link' onClick={()=>{handleBlank(); hideNav()}}><IoIosRocket />Milestones</li>
            <li className='nav-link' onClick={()=>{handleBlank(); hideNav()}}><VscFiles />Files</li>
            ...
            <li className='nav-link' onClick={()=>{handleBlank(); hideNav()}}><IoIosRocket />Tickets</li>
            <li className='nav-link' onClick={()=>{handleContracts(); hideNav()}}><AiFillFile />Contracts</li>
            <li className='nav-link' onClick={()=>{handleBlank(); hideNav()}}><HiOutlineScale />Sales</li>
            <li className='nav-link' onClick={()=>{handleBlank(); hideNav()}}><AiOutlineFile />Notes</li>
            <li className='nav-link' onClick={()=>{handleBlank(); hideNav()}}><BsExclamationLg />Activity</li>
        </ul>
      </div>
